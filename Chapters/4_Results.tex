...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.7\linewidth]{Figures/saliencyslider.png}}    \caption{Interface of the SaliencySlider web tool demonstrating saliency overlays.}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.934\linewidth]{Figures/difflogicvisualizer.png}}    
